...
function OnKeyReceivedHandler(event) {
	...
	//if(keyStatus == 0){
		...
		alert("OnKeyReceivedHandler Camehere1 \n");
        //var str = JSON.stringify(event); //JSON.stringify(event, null, 4);
        alert("keystatus : " + keyStatus + "  keycode : " + keyCode + "\n");
        alert(" eventval : " + event + " \n");
        keyHandler(keyCode);
        alert("OnKeyReceivedHandler Camehere2 \n");
	}
	else
    {
    alert("OnKeyReceivedHandler Camehere3 \n");
    alert("keystatus : " + keyStatus + "  keycode : " + keyCode + "\n");
    alert(" eventval : " + event + " \n");
    alert("OnKeyReceivedHandler Camehere4 \n");
    }
